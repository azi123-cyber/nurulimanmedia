...
const Admissions: React.FC = () => {
  ...
  return (
    <div className="pt-24 min-h-screen px-6 pb-20 max-w-5xl mx-auto">
      <motion.div 
      ...
      <motion.div 
        ...
        className="bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-3xl p-8 md:p-12 mb-16 relative overflow-hidden"
      >
